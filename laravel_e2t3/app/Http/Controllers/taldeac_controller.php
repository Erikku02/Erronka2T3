...
use App\Models\Taldea_Model;

class taldeac_controller extends Controller
{
    public function index()
    {
        $table = Taldea_Model::all();
        return response()->json($table, 200);
    }

    public function erakutsi($kodea)
    {
        $table = Taldea_Model::where('kodea', $kodea)->first();
        return response()->json($table, 200);
    }
    ...
    public function gorde(Request $aux)
    {
        ...
        Taldea_Model::insert($nuevoTalde);
    ...
    public function eguneratu(Request $aux, $kodea)
    {
        ...
        $eguneratuTaula = Taldea_Model::where('kodea', $kodea)->update($taldeEguneratuta);
    ...
    {
        $taldea = Taldea_Model::where('kodea', $kodea)->first();
